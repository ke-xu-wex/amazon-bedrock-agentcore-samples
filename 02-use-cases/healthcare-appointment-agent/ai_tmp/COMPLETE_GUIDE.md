...
### Goals Achieved
- ✅ Deploy MCP Gateway with 5 healthcare tools
- ✅ Implement OAuth2 authentication (ingress + egress)
- ✅ Use mock data to eliminate expensive managed services
- ✅ Integrate with Google Gemini to bypass AWS SCP restrictions
- ✅ Demonstrate end-to-end agent workflow
...
│                                              │
│  ┌────────────────────────────────────────┐ │
│  │  langgraph_agent_gemini.py             │ │
│  │  (Python Agent Application)            │ │
│  │                                         │ │
│  │  ┌──────────────────────────────────┐  │ │
│  │  │  Google Gemini 2.5 Flash         │  │ │
│  │  │  (LLM - bypasses AWS SCP)        │  │ │
│  │  └──────────────┬───────────────────┘  │ │
│  │                 │                       │ │
│  │  ┌──────────────▼───────────────────┐  │ │
│  │  │  LangGraph Agent                 │  │ │
...
│  │  ┌──────────────────────────────────────────────────────┐   │ │
│  │  │  MCP Gateway                                         │   │ │
│  │  │  ID: healthcare-fhir-gateway-fqssvsgzsg             │   │ │
│  │  │                                                      │   │ │
│  │  │  ┌──────────────────────────────────────────────┐   │   │ │
│  │  │  │  Gateway Target                              │   │   │ │
│  │  │  │                                               │   │   │ │
...
│  │  │  │  • 5 Tools Available:                        │   │   │ │
│  │  │  │    1. getPatient                             │   │   │ │
│  │  │  │    2. searchImmunization                     │   │   │ │
│  │  │  │    3. bookAppointment                        │   │   │ │
│  │  │  │    4. getSlots                               │   │   │ │
│  │  │  │    5. searchPatient                          │   │   │ │
│  │  │  │                                               │   │   │ │
│  │  │  │  • OAuth2 Egress Credential Provider        │   │   │ │
│  │  │  └───────────────────┬───────────────────────┘   │   │ │
│  │  └────────────────────────┼─────────────────────────┘   │ │
│  └───────────────────────────┼───────────────────────────────┘ │
│                              │ OAuth2 Token                    │
...
│  │  │  URL: https://y2wd96t0fb.execute-api...          │    │ │
│  │  │                                                   │    │ │
│  │  │  Endpoints:                                       │    │ │
│  │  │  - GET  /get_patient_emr                         │    │ │
│  │  │  - POST /search_immunization_emr                 │    │ │
...
│  │  ┌──────────────────────────────────────────────────┐  │  │
│  │  │  AWS Lambda Function                             │  │  │
│  │  │  Name: fhir-mcp-lambda-*                        │  │  │
│  │  │  Runtime: Python 3.11                            │  │  │
│  │  │                                                   │  │  │
│  │  │  MOCK DATA (No Database):                        │  │  │
│  │  │  ┌─────────────────────────────────────────┐    │  │  │
│  │  │  │ • 2 Patients (hardcoded)                │    │  │  │
│  │  │  │   - Richard Doe (adult-patient-001)     │    │  │  │
│  │  │  │   - John Doe (pediatric-patient-001)    │    │  │  │
│  │  │  │                                          │    │  │  │
│  │  │  │ • 10 Immunization Records                │    │  │  │
│  │  │  │   - 7 completed (IPV, DTaP, PCV13...)   │    │  │  │
│  │  │  │   - 3 pending (MMR, Varicella...)       │    │  │  │
│  │  │  │                                          │    │  │  │
│  │  │  │ • 1 Practitioner                         │    │  │  │
│  │  │  │   - Dr. Sarah Johnson                    │    │  │  │
│  │  │  │                                          │    │  │  │
│  │  │  │ • Dynamic Appointment Slots              │    │  │  │
│  │  │  │   - Generated around requested dates    │    │  │  │
│  │  │  └─────────────────────────────────────────┘    │  │  │
│  │  └──────────────────────────────────────────────────┘  │  │
│  └─────────────────────────────────────────────────────────┘  │
│                                                                │
...
│  │  ┌────────────────────────────────────────────────┐    │  │
│  │  │  Amazon S3                                     │    │  │
│  │  │  Bucket: healthcare-mcp-demo-1764972468-...   │    │  │
│  │  │  - Lambda deployment package (1.1 MB)          │    │  │
...
1️⃣  USER STARTS AGENT
    ...
    │   --gateway_id healthcare-fhir-gateway-...   │
    └───────────────────────────────────────────────┘
    ▼
...
2️⃣  AGENT INITIALIZATION
    ...
    │    - AWS credentials                                   │
    │    - Google API key from .env.api-key                 │
    │    - Gateway configuration                             │
    │                                                         │
    │ B. Get Gateway Endpoint                                │
    │    boto3 → bedrock-agentcore.GetGateway()             │
    │    Returns: https://healthcare-fhir-gateway...         │
    │                                                         │
    │ C. Obtain JWT Token                                    │
    ...
    │                                                         │
    │ D. Connect to MCP Gateway                              │
    │    MCP Client → Gateway /mcp endpoint                  │
    │    Header: Authorization: Bearer <JWT>                 │
    │    Returns: List of 5 MCP tools                        │
    │                                                         │
    │ E. Initialize LLM                                      │
...
3️⃣  USER INPUT
    ┌────────────────────────────────────────────┐
    │ 👤 You: What is the name of patient       │
    │         adult-patient-001?                 │
    └────────────────────────────────────────────┘
    ▼

4️⃣  AGENT PROCESSING (LangGraph + Gemini)
    ┌────────────────────────────────────────────────────────┐
    ...
    │    )                                                    │
    │                                                         │
    │ B. Agent calls Google Gemini                           │
    │    Request to Gemini API:                              │
    │    {                                                    │
    │      "messages": [...conversation history],            │
    │      "tools": [getPatient, searchImmunization, ...],   │
    │      "system": "You are a healthcare agent..."         │
    │    }                                                    │
    │                                                         │
    │ C. Gemini decides to use tool                          │
    │    Gemini Response:                                    │
    │    {                                                    │
    │      "tool_calls": [{                                  │
    │        "name": "getPatient",                           │
...
5️⃣  MCP TOOL INVOCATION
    ┌────────────────────────────────────────────────────────┐
    │ A. Agent → MCP Gateway                                 │
    │    POST https://healthcare-fhir-gateway.../mcp         │
    │    Headers:                                             │
    ...
    │    }                                                    │
    │                                                         │
    │ B. Gateway validates JWT                               │
    │    - Checks JWT signature against Cognito              │
    │    - Validates token expiration                        │
    │    - Checks allowed scopes                             │
    │                                                         │
    │ C. Gateway translates MCP → REST API                   │
    │    MCP tool "getPatient" maps to:                      │
    │    GET /get_patient_emr?patient_id=adult-patient-001   │
    │                                                         │
    │ D. Gateway gets OAuth2 token (Egress)                  │
    │    Uses OAuth2 Credential Provider                     │
    │    POST to Cognito /oauth2/token                       │
    │    Returns: access_token for API Gateway               │
    └────────────────────────────────────────────────────────┘
    ▼

6️⃣  API GATEWAY → LAMBDA
    ┌────────────────────────────────────────────────────────┐
    │ A. Gateway → API Gateway                               │
    │    GET https://y2wd96t0fb.execute-api.us-east-1...    │
    │        /dev/get_patient_emr?patient_id=adult-patient-001│
    │    Headers:                                             │
    │      Authorization: Bearer <OAUTH2_TOKEN>              │
    │                                                         │
    │ B. API Gateway validates OAuth2 token                  │
    │    - Cognito User Pool Authorizer                      │
    │    - Checks token signature and scope                  │
    │                                                         │
    │ C. API Gateway invokes Lambda                          │
    │    Event:                                               │
    │    {                                                    │
    │      "resource": "/get_patient_emr",                   │
    │      "httpMethod": "GET",                              │
...
7️⃣  LAMBDA PROCESSING (Mock Data)
    ┌────────────────────────────────────────────────────────┐
    │ A. Lambda handler receives event                       │
    │    def lambda_handler(event, context):                 │
    │        patient_id = event['queryStringParameters']...  │
    │                                                         │
    │ B. Lambda looks up mock data                           │
    │    MOCK_PATIENTS = {                                   │
    │      "adult-patient-001": {                            │
    ...
    │    }                                                    │
    │                                                         │
    │ C. Lambda returns patient data                         │
    │    return {                                             │
    │      "statusCode": 200,                                │
    │      "body": json.dumps({                              │
    │        "body": {                                        │
    │          "patientRecord": MOCK_PATIENTS[patient_id]    │
    │        }                                                │
    │      })                                                 │
    │    }                                                    │
    └────────────────────────────────────────────────────────┘
...
8️⃣  RESPONSE CHAIN
    ┌────────────────────────────────────────────────────────┐
    │ Lambda → API Gateway → MCP Gateway → Agent            │
    │                                                         │
    │ Response:                                               │
    │ {                                                       │
    │   "patientRecord": {                                   │
...
9️⃣  AGENT FORMATS RESPONSE
    ┌────────────────────────────────────────────────────────┐
    │ A. Agent sends tool result to Gemini                   │
    │    {                                                    │
    │      "role": "tool",                                   │
    │      "tool_call_id": "...",                            │
    ...
    │    }                                                    │
    │                                                         │
    │ B. Gemini generates final response                     │
    │    "The name of patient adult-patient-001 is           │
    │     Richard Doe."                                       │
    │                                                         │
    │ C. Agent streams response to user                      │
...
🔟 USER SEES RESPONSE
    ┌────────────────────────────────────────────┐
    │ 🤖 Healthcarebot: The name of patient     │
    │    adult-patient-001 is Richard Doe.       │
    └────────────────────────────────────────────┘
```
...
╔═══════════════════════════════════════════════════════════════╗
║  LAYER 1: INGRESS AUTHENTICATION (Agent → Gateway)            ║
╚═══════════════════════════════════════════════════════════════╝

1️⃣  Agent Requests JWT Token
    ┌──────────────────────────────────────────────────────┐
    │ POST https://us-east-1e05e44f0.auth.us-east-1...    │
    │      /oauth2/token                                    │
    │                                                       │
    │ Headers:                                              │
    ...
    │   client_id=25ifnbk88dn166mvsu61k9a4pl               │
    │   client_secret=<retrieved from Cognito>            │
    ...
    │ Cognito Response:                                     │
    │ {                                                     │
    │   "access_token": "eyJraWQ...very.long.jwt",        │
    │   "expires_in": 3600,                                │
    │   "token_type": "Bearer"                             │
    │ }                                                     │
    │                                                       │
    ...
    │ {                                                     │
    │   "sub": "25ifnbk88dn166mvsu61k9a4pl",              │
    │   "token_use": "access",                             │
    │   "scope": "default-m2m-resource-server-../read",   │
    │   "iss": "https://cognito-idp.us-east-1...",        │
    │   "exp": 1733419727,                                 │
    │   "iat": 1733416127,                                 │
    │   "client_id": "25ifnbk88dn166mvsu61k9a4pl"         │
    │ }                                                     │
...
2️⃣  Agent Calls MCP Gateway with JWT
    ┌──────────────────────────────────────────────────────┐
    │ POST https://healthcare-fhir-gateway-fqssvsgzsg...   │
    │      .gateway.bedrock-agentcore.us-east-1...         │
    │                                                       │
    │ Headers:                                              │
    │   Authorization: Bearer eyJraWQ...jwt.token          │
    │   Content-Type: application/json                     │
    └──────────────────────────────────────────────────────┘

3️⃣  Gateway Validates JWT
    ┌──────────────────────────────────────────────────────┐
    │ MCP Gateway Validation Steps:                        │
    │                                                       │
    │ A. Fetch JWKS from Cognito Discovery URL             │
    │    GET https://cognito-idp.us-east-1.amazonaws.com/ │
    │        us-east-1_XcXhrmQys/.well-known/              │
    │        openid-configuration                          │
    │                                                       │
    │ B. Verify JWT Signature                              │
    │    - Uses public key from JWKS                       │
    │    - Validates signature matches                     │
    │                                                       │
    │ C. Validate JWT Claims                               │
    │    ✓ Check expiration (exp < current_time)          │
    │    ✓ Check issuer (iss = expected Cognito)          │
    │    ✓ Check client_id in allowed list                │
    │    ✓ Check scope matches requirements               │
    │                                                       │
    │ D. If Valid → Process Request                        │
    │    If Invalid → Return 401 Unauthorized              │
    └──────────────────────────────────────────────────────┘

╔═══════════════════════════════════════════════════════════════╗
║  LAYER 2: EGRESS AUTHENTICATION (Gateway → API)              ║
╚═══════════════════════════════════════════════════════════════╝

4️⃣  Gateway Needs to Call Backend API
    ┌──────────────────────────────────────────────────────┐
    │ Gateway has validated the incoming request           │
    │ Now needs to call API Gateway with its own token    │
    └──────────────────────────────────────────────────────┘

5️⃣  Gateway Uses OAuth2 Credential Provider
    ┌──────────────────────────────────────────────────────┐
    │ A. Gateway invokes Credential Provider               │
    │    Provider ARN: arn:aws:bedrock-agentcore:...       │
    │                 /credential-provider/healthcare-...  │
    │                                                       │
    │ B. Provider Requests Token from Cognito              │
    │    POST https://us-east-1e05e44f0.auth...            │
    │         /oauth2/token                                │
    │                                                       │
    │    Body:                                              │
    │      grant_type=client_credentials                   │
    │      client_id=25ifnbk88dn166mvsu61k9a4pl           │
    │      client_secret=<stored in provider>             │
    │      scope=default-m2m-resource-server-../read      │
    │                                                       │
    │ C. Cognito Returns OAuth2 Access Token               │
    │    {                                                  │
    │      "access_token": "eyJraWQ...egress.token",      │
    │      "expires_in": 3600,                             │
    │      "token_type": "Bearer"                          │
    │    }                                                  │
    │                                                       │
    │ D. Provider Caches Token (until expiration)         │
    └──────────────────────────────────────────────────────┘

6️⃣  Gateway Calls API Gateway with OAuth2 Token
    ┌──────────────────────────────────────────────────────┐
    │ GET https://y2wd96t0fb.execute-api.us-east-1...     │
    │     /dev/get_patient_emr?patient_id=adult-patient-001│
    │                                                       │
    │ Headers:                                              │
    │   Authorization: Bearer eyJraWQ...egress.token       │
    └──────────────────────────────────────────────────────┘

7️⃣  API Gateway Validates OAuth2 Token
    ┌──────────────────────────────────────────────────────┐
    │ API Gateway Cognito Authorizer:                      │
    │                                                       │
    │ A. Fetch JWKS from Cognito                           │
    │    (same discovery endpoint)                         │
    │                                                       │
    │ B. Verify Token Signature                            │
    │                                                       │
    │ C. Validate Claims                                    │
    │    ✓ Check exp, iss, client_id, scope               │
    │    ✓ Verify scope matches required scope            │
    │                                                       │
    │ D. If Valid → Invoke Lambda                          │
    │    If Invalid → Return 403 Forbidden                 │
    └──────────────────────────────────────────────────────┘

8️⃣  Lambda Executes (No Additional Auth Needed)
    ┌──────────────────────────────────────────────────────┐
    │ Lambda assumes request is authenticated               │
...
│ Request Path:                                                 │
│                                                               │
│ Agent ──JWT──▶ MCP Gateway ──OAuth2──▶ API Gateway ──▶ Lambda│
│         (1)                     (2)                           │
│                                                               │
│ (1) Ingress Auth: JWT from Cognito                          │
│     - Validates agent identity                               │
│     - Ensures authorized MCP access                          │
│                                                               │
│ (2) Egress Auth: OAuth2 from Credential Provider            │
│     - Validates gateway identity                             │
│     - Ensures authorized API access                          │
│                                                               │
│ Both tokens from SAME Cognito User Pool                     │
│ Both use client_credentials grant type (M2M)                │
│ Both validated against same JWKS                             │
└──────────────────────────────────────────────────────────────┘
```
...
#### 1. Ingress Authentication (Agent → Gateway)
...
#### 2. Egress Authentication (Gateway → API)
...
1. ✅ **Mutual TLS**: All communications over HTTPS
2. ✅ **Token Expiration**: JWT tokens expire after 1 hour
3. ✅ **Scope-Based Access**: OAuth2 scopes limit access
4. ✅ **Secret Management**: Client secrets stored in Cognito (not in code)
5. ✅ **IAM Least Privilege**: Each role has minimal permissions
6. ✅ **JWT Validation**: Signature and claims verification
7. ✅ **Token Caching**: Gateway caches egress tokens efficiently
8. ✅ **No Hardcoded Credentials**: All credentials dynamically retrieved
...
async def main(gateway_endpoint, jwt_token):
    ...
    print(f"✓ Connected to MCP Gateway with {len(tools)} tools")
...
├─────────────────────────────────────────────────────────────┤
│                                                              │
│  Original (HealthLake):  $730 × 12 = $8,760 per year       │
│  ██████████████████████████████████████████████████████████ │
│                                                              │
│  Modified (Mock Data):   $2 × 12 = $24 per year            │
│  █                                                           │
│                                                              │
│  SAVINGS: $8,736 per year (99.7% reduction)                │
│                                                              │
└─────────────────────────────────────────────────────────────┘
```
...
- Gateway handles all protocol translation (REST ↔ MCP)
...
├── cloudformation/
│   ├── healthcare-cfn.yaml                    # Modified CloudFormation (no HealthLake)
│   ├── fhir-openapi-searchpatient.zip        # Lambda deployment package
│   └── fhir-openapi-searchpatient/
│       └── lambda_function.py                 # Lambda with mock data
├── test_data/
│   ├── patient.json                           # Original test data (not used)
│   └── immunization.json                      # Original test data (not used)
├── requirements.txt                           # Python dependencies
├── init_env.py                                # Environment setup script
├── setup_fhir_mcp.py                          # Gateway setup script
├── utils.py                                   # Utility functions (OAuth, etc.)
├── fhir-openapi-spec.yaml                    # OpenAPI specification
├── strands_agent.py                          # Strands agent (Bedrock-based)
├── langgraph_agent.py                        # LangGraph agent (Bedrock-based)
├── langgraph_agent_gemini.py                 # LangGraph agent (Gemini-based) ✓
├── create_test_data.py                       # Data ingestion (not used)
